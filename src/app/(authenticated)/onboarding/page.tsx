        ...
        return (
          <>
            <CardHeader>
              ...
              <CardDescription>
                Set up your organization to get started with Wavv.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-end pt-4">
                <Button
                  ...
                  disabled={isSaving || !orgName.trim() || isOrgCreated}
                  size="lg"
                >
                  {isSaving ? (
                    <>
        ...
        return (
          <>
            <CardHeader>
              ...
              <CardDescription>
                Choose the SharePoint sites you want to audit with AI.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {isLoadingSites ? (
        ...
        return (
          <>
            <CardHeader>
              ...
              <CardDescription>
                Invite colleagues to join your organization (optional).
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="flex items-center justify-center gap-2">
            {STEPS.map((step, index) => {
              ...
              const isCompleted = canProceedFromStep(index) && currentStep > index
              ...
              return (
                <div key={step.id} className="flex items-center">
                  ...
                  {index < STEPS.length - 1 && (
                    <div
                      className={`w-16 h-0.5 mb-6 mx-2 transition-colors ${isCompleted ? 'bg-primary' : 'bg-muted'
                        }`}
                    />
                  )}
                </div>
