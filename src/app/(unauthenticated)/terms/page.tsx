...
import { ArrowLeft, FileText, Scale, AlertCircle, CreditCard, Ban, RefreshCw, Gavel, Menu, X } from 'lucide-react'
          ...
          <div className="prose prose-neutral max-w-none">
            ...
            >
              ...
              <p className="leading-relaxed" style={{ color: 'var(--mono-secondary-gray)' }}>
                ...
                <a href="mailto:legal@wavv.ai" className="underline hover:no-underline" style={{ color: 'var(--mono-black)' }}>
                  legal@wavv.ai
                </a>
              </p>
            </motion.div>
