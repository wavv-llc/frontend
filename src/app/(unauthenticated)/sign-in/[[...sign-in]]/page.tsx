                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        Sign in to access your intelligent tax
                                        workspace
                                    </p>
                                </motion.div>
                            </div>
                            ...
                            >
                                <div className="w-full">
                                    <SignIn
                                        ...
                                        appearance={{
                                            elements: {
                                                ...
                                                main__body:
                                                    '!bg-transparent w-full !p-0 !flex !flex-col !items-center',

                                                // Social Buttons - styled to match landing page
                                                socialButtonsBlockButton:
                                                    '!relative !overflow-visible !border !bg-white/50 !w-full !flex !items-center !justify-center !gap-2 !h-10 !rounded-lg !mb-0 !shadow-sm transition-all hover:!shadow-md hover:!scale-[1.01] !px-4',
                                                ...
                                                // Divider
                                                dividerRow:
                                                    '!flex !items-center !justify-between !my-4 !w-full',
                                                dividerLine: '!h-px !flex-grow',
                                                dividerText:
                                                    '!text-xs !uppercase !tracking-wider !bg-transparent !px-4',
                                                ...
                                                formFieldLabel:
                                                    '!text-sm !font-medium !mb-2 !text-left !block !w-full',
                                                formFieldInput:
                                                    '!w-full !h-10 !rounded-lg !border !bg-white/50 !px-4 !text-sm focus:!ring-2 transition-all !box-border',

                                                // Primary Button - styled to match landing page CTA
                                                formButtonPrimary:
                                                    '!w-full !h-11 !rounded-lg !text-base !font-medium hover:!shadow-lg transition-all hover:!scale-[1.02] hover:!brightness-95 !shadow-sm !mt-2 !px-4',
                                                ...
                                                // Other
                                                identityPreview:
                                                    '!border !rounded-lg !p-3 !mb-3 !w-full',
                                    ...
                                    {/* Footer Link */}
                                    <div
                                        className="mt-5 pt-4 border-t w-full"
                                        style={{
                                            borderColor:
                                                'var(--mono-border-gray)',
                                        }}
                                    >
                                        <p
