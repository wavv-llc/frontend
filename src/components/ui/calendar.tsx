...
function Calendar({
    ...
    return (
        <div className={cn("p-4 bg-background rounded-lg border border-border shadow-lg", className)}>
            {/* Header */}
                    ...
                    return (
                        <button
                            ...
                            className={cn(
                                ...
                                today && !selectedDay && "bg-accent/50 font-semibold border border-primary/20",
                                selectedDay && "bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground font-semibold shadow-sm",
                                disabledDay && "opacity-50 cursor-not-allowed hover:bg-transparent"
                            )}
                        >
                            {date.getDate()}
                            {today && !selectedDay && (
